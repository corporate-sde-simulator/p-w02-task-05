...
> **Welcome to Product-Track Week 2, Task 5!**
...
| `src/signatureMiddleware.js` | Main source code - **has bugs to fix** |
| `src/signatureVerifier.js` | Supporting code - **may also have bugs** |
| `tests/test_signatureVerifier.test.js` | Test file - **add your tests here** |
